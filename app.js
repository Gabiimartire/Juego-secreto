...
function pausarEvento(input) {
  input.removeEventListener('keypress', enter);
}

function reanudarEvento(input) {
  input.addEventListener('keypress', enter);
}
...
function reiniciarJuego() {
    ...
    //Habilitar el boton intentar otra vez
    document.getElementById('verificar').removeAttribute('disabled');
    //el escuchador del enter en el input vuelve
    reanudarEvento(input)
}
condicionesIniciales();
